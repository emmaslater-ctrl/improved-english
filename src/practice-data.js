...
<p>The graph shows that unbecoming rose steadily from 1750, peaked around the mid-19th century at roughly 0.0006%, and declined gradually thereafter. Inappropriate remained near zero until around 1940, after which it rose sharply, overtaking unbecoming</em> by the 1960s and continuing to climb to roughly 0.0013% by 2000.</p>
...
<p>Bailey: ˚somebody˚ um (2) oh did you see that on my /sʌm/ [holds up her thumb]</em></p>
...
<p style="font-size:13px; color:#5a6c87;">Transcript key: (1) = pause in seconds; (.) = micropause; <u>underlined</u> = stressed; // = overlap; [italics]</em> = paralinguistic; ˚word˚ = quiet; ↗ = rising intonation; ↘ = falling.</p>`
          }
        ],
        plan: {
...
<p>The graph shows that jail rose unevenly through the 19th century, peaked in the 1960s–70s, and remained dominant into the 2000s. Gaol remained at low frequency throughout, declining to near zero by 2000.</p>`
        ...
        plan: {
          ...
          structure: [
            ...
            "Grammar & syntax: Long, semicolon-joined sentences; cleft structures ('It is from this neglected class…'); institutional we</em>. Connect to Fairclough's informalisation and Mair's colloquialisation.",
          ...
          theorists: [
            ...
            "Aitchison — narrowing of class</em>; PIDC for jail/gaol",
            "Crystal — tide metaphor for gaol</em>",
...
<p>However, it would be too quick to dismiss the article's claim entirely. The weak relativity version of the hypothesis — that language influences but does not determine thought — has substantial empirical support. Lera Boroditsky's research has shown measurable cognitive effects of linguistic categories, including her well-known study of Russian speakers' faster discrimination of light blue (goluboy</em>) and dark blue (siniy</em>). The effects are real but modest. Translated to the article's argument, weak relativity would predict that English speakers' default associations with deafness are subtly shaped by repeated exposure to ableist idioms, even if they remain capable of overriding those associations.</p>
