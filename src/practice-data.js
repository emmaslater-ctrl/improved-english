     ...
     ============================================================ */
  {
    ...
    questions: [
      ...
      /* === 2022 Nov 31 — Letter from a Father === */
      {
        ...
        marks: 25,
        prompt: "Read Texts A, B and C. Analyse how Text A exemplifies the various ways in which the English language has changed over time. In your answer, you should refer to specific details from Texts A, B and C, as well as to ideas and examples from your wider study of language change.",
        sources: [
          {
            label: "Text A — A Letter from a Father (1774)",
            text: `<p>An extract from a letter written in 1774 by a father to his daughter at boarding school.</p>
...
<p style="font-size:13px; color:#5a6c87; margin-top:14px;">¹ unbecoming: inappropriate, not flattering</p>`
          },
          {
            label: "Text B — Top modifiers of 'humour'",
            text: `<p>Five of the top modifiers of 'humour' from the Early English Books Corpus (1470s–1690s) and from the English Web 2015 corpus (texts collected from the internet in 2015).</p>
...
<p style="font-size:13px; color:#5a6c87;">¹ peccant: sinful</p>`
          },
          {
            label: "Text C — n-gram graph: unbecoming vs inappropriate (1750–2000)",
            text: `<p>n-gram graph for the words unbecoming and inappropriate (1750–2000).</p>
<p>The graph shows that unbecoming rose steadily from 1750, peaked around the mid-19th century at roughly 0.0006%, and declined gradually thereafter. Inappropriate remained near zero until around 1940, after which it rose sharply, overtaking unbecoming by the 1960s and continuing to climb to roughly 0.0013% by 2000.</p>
<p style="font-size:13px; color:#5a6c87; margin-top:10px; font-style:italic;">[The original graph appeared in the 9093/31 Oct/Nov 2022 question paper.]</p>`
        ...
        plan: {
          ...
          structure: [
            "Intro: 'Text A is a letter written in 1774 by a father to his daughter at boarding school. It provides a valuable insight into Early Modern English (EME) and, when read alongside Texts B and C, illustrates how the English language has changed significantly in terms of graphology, orthography, morphology, phonology, lexis and grammar over the past two and a half centuries.'",
            "Lexis & semantics: 'humour' (Text B narrowing — Aitchison/Halliday); 'nay', 'farther', 'unbecoming'; cross-reference Text C for the unbecoming/inappropriate replacement (Crystal's tide).",
            "Orthography & graphology: long-s ﬃ; 'publick' for 'public' (Johnson 1755 still settling); 'every body' as separate words; reference Caxton (1476) for the start of standardisation; GVS as cause of spelling–pronunciation lag if relevant.",
            "Morphology: compound words still spaced ('every body', 'ſome how') — show how compounding progresses from spaced → hyphenated → closed; final silent 'e' patterns; double-consonant in 'publick'.",
            "Grammar & syntax: long, semicolon-joined sentences; imperative mood ('Believe me', 'Let a woman'); reference Fairclough's informalisation and Mair's colloquialisation as the contrasting modern trend.",
            "(Optional) Phonology / Pragmatics: 'ſhew' for 'show' as evidence of GVS-driven phonological change; pragmatic note on the gendered prescriptive register.",
            "Conclusion (2 sentences): Texts A, B, C together show change across multiple linguistic levels driven by both internal pressures and external social shifts."
          ],
          theorists: [
            "Aitchison — narrowing/PIDC for 'humour'",
            "Halliday — functional theory: words fade as concepts (the four humours) fade",
            "Crystal — tide metaphor for the unbecoming → inappropriate replacement",
            "Caxton — printing press 1476 began graphological standardisation",
            "Johnson — 1755 dictionary; 19 years before this letter, so still settling",
            "GVS — Great Vowel Shift causes 'shew/show' spelling lag",
            "Fairclough — informalisation contrast; Mair — colloquialisation"
          ],
...
<p>One of the most striking features of Text A is its graphology. The text makes consistent use of the long-s (ſ), appearing in the middle of words such as "adviſe" and "ariſe." The long-s grapheme does not appear at the start or end of words, a rule that reflects the conventions of 18th-century printing. The text also contains a ct ligature, visible in words such as "contract" and "action," where the letters are joined. Both features became obsolete as printing houses moved towards more standardised, modern typefaces. William Caxton's introduction of the printing press in the 1470s began this process of graphological standardisation, gradually removing such features in favour of consistency. For a modern reader, these graphological differences immediately signal the historical distance of the text.</p>
...
<p>Overall, Texts A, B and C together illustrate how English has evolved significantly over the past 250 years across multiple linguistic levels. These changes reflect not only internal linguistic pressures, such as the drive towards standardisation and efficiency, but also broader social and cultural shifts in how language is used and valued.</p>`,
        ...
        markScheme: `<p>Cambridge expects responses to integrate evidence from all three texts with named theorists. The mark scheme highlights the following expected content:</p>
<h4>Lexis and semantics</h4>
<ul>
<li>humour — semantic narrowing supported by Text B's modifier shift; link to obsolete medical concept</li>
<li>nay, farther, thither — low-frequency lexical items</li>
<li>unbecoming vs inappropriate — lexical replacement evidenced by Text C n-gram</li>
</ul>
...
<li>Use of subject pronoun we in formal address</li>
</ul>
<h4>Orthography and graphology</h4>
<ul>
<li>Long-s (ſ) — abandoned in early 19th century printing</li>
<li>publick for public — pre-Johnson orthographic conventions</li>
...
<p>Mother: who are you calling↗</p>
<p>Bailey: ˚somebody˚ um (2) oh did you see that on my /sʌm/ [holds up her thumb]</p>
<p>Mother: what happened↗</p>
<p>Bailey: um (.) i dont know</p>
<p>Mother: did lola scratch you↗</p>
<p>Bailey: no rory↘</p>
<p>Mother: rory scratched you↗ //</p>
<p>Bailey: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; yeah</p>
<p>Mother: im sorry↘ //</p>
<p>Bailey: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i didnt know how it did it (.) i didnt know how it comed out (.) um (.) rorys paws (.) i didnt know how it comed out</p>
<p>Mother: her claws</p>
<p>Bailey: yeah</p>
<p>Mother: theyre sharp arent they</p>
<p>Bailey: yeah (1) i didnt know that it comed out (.) i didnt know that it comed out of her paws</p>
<p>Mother: you didnt↗ (1) oh my goodness (2) who are you talking to</p>
<p>Bailey: can you talk to somebody (2) im doing it on my ear</p>
<p>Mother: but <u>who</u> is it↘</p>
<p>Bailey: its bunnyhorse</p>
<p>Mother: bunnyhorse↗ (.) whats bunnyhorse doing↘</p>
<p>Bailey: he just /peɪɪŋ/ at home and waiting for his mama to come and he daddy (.) his aunt is watching him right now</p>
<p>Mother: who is↗</p>
<p>Bailey: his aunt</p>
<p>Mother: his aunt is watching him↗ //</p>
<p>Bailey: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; yeah</p>
<p>Mother: oh my goodness (.) is he having fun with her↗</p>
<p>Bailey: yeah and /deɪ/ making eggs right now</p>
<p>Mother: eggs↗</p>
<p>Bailey: and potato too</p>
<p>Mother: oh my (.) that sounds good</p>
<p>Bailey: oh bunny says er (.) bunnyhorse says hes got go to eat dinner</p>
<p>Mother: hes got to go to eat dinner↗</p>
<p>Bailey: yeah (1) my phone is called (2) is yours big↗</p>
<p>Mother: yeah mine is a little bit bigger</p>
<p>Bailey: it big↗</p>
<p>Mother: just a little bigger (.) how about (.) let me see yours (.) hold yours up</p>
<p>Bailey: mine are little</p>
<p>Mother: yes yours is little</p>
</div>
<p style="font-size:13px; color:#5a6c87; margin-top:14px;">¹ lola and rory: the names of Bailey and Mother's pet cats.</p>
<p style="font-size:13px; color:#5a6c87;">Transcript key: (1) = pause in seconds; (.) = micropause; <u>underlined</u> = stressed; // = overlap; [italics] = paralinguistic; ˚word˚ = quiet; ↗ = rising intonation; ↘ = falling.</p>`
          }
        ],
        plan: {
          ...
          structure: [
            "Intro: Identify the developmental stage (late telegraphic/early post-telegraphic, Brown) and outline the analytical framework — Bailey's emerging competence, the mother's CDS scaffolding.",
            "Pragmatics & Halliday's functions: Turn-taking, adjacency pairs, interactional ('can you talk to somebody'), representational ('his aunt is watching him'), imaginative ('bunny says').",
            "Grammar: Auxiliaries ('is watching'), pronouns ('his', 'my', 'mine'), prepositions ('on my ear'). Then the virtuous error 'comed out' — Chomsky's LAD.",
            "Phonology: Consonant omission in /peɪɪŋ/ for 'playing'; substitution of /θ/ → /d/ in /deɪ/ for 'they'. Link Piaget's preoperational stage for symbolic play.",
            "CDS — mother's strategies: Rising intonation on declaratives, recasting ('mine are little' → 'yes yours is little'), expansion ('rorys paws' → 'her claws'), positive reinforcement ('oh my, that sounds good') — Skinner, Bruner LASS, Vygotsky ZPD.",
            "Theoretical synthesis (top-band): Bailey's competence reflects both innate capacity (Chomsky) and supportive interaction (Bruner, Vygotsky) — the rival accounts together explain what neither alone can.",
            "Conclusion (2 sentences): Language acquisition is dynamic and interactive; Bailey's development is broadly consistent with — and slightly ahead of — what is expected at age 3."
          ],
          theorists: [
            "Brown — five stages (Bailey is late telegraphic / early post-telegraphic)",
            "Halliday — interactional, representational, imaginative functions",
            "Chomsky — virtuous error 'comed' as LAD evidence",
            "Skinner — positive reinforcement 'oh my, that sounds good'",
            "Bruner — LASS scaffolding through CDS",
            "Vygotsky — ZPD; recasting as MKO operating just above Bailey's level",
            "Piaget — preoperational stage; symbolic play with 'bunnyhorse'"
          ],
...
<p>The mother's language throughout is a clear example of child-directed speech (CDS). She frequently uses rising intonation on declaratives to form questions ("rory scratched you↗") which both checks her understanding and invites Bailey to confirm or correct. She asks a wide range of questions ("who are you calling↗," "what happened↗," "but who is it↘"), which serve to prompt Bailey's participation and develop her ability to fulfil adjacency pairs. Crucially, she provides positive reinforcement ("oh my, that sounds good") which aligns with Skinner's behaviourist framework, suggesting that rewarding correct communicative utterances encourages further engagement. This also reflects Bruner's Language Acquisition Support System (LASS), which emphasises the role of a supportive interactional framework in scaffolding language development. The mother provides this framework consistently by reformulating Bailey's utterances, introducing new vocabulary ("her claws"), and maintaining a warm, encouraging tone throughout.</p>

<p>A particularly effective CDS strategy the mother employs is recasting. When Bailey says "mine are little," the mother responds "yes yours is little", correcting Bailey's pronoun-number agreement without explicitly drawing attention to the error. This allows Bailey to hear the correct form in context without being made to feel she has made a mistake, thereby maintaining her confidence and willingness to participate. This technique reflects Vygotsky's concept of the Zone of Proximal Development (ZPD) and the role of the More Knowledgeable Other (MKO): the mother consistently operates just beyond Bailey's current level of competence, gently stretching her linguistic ability through interaction rather than direct instruction. Similarly, when the mother supplies "her claws" in response to Bailey's "rorys paws," she is expanding Bailey's vocabulary in a natural, contextualised way, consistent with Bruner's LASS framework.</p>

<p>It is worth acknowledging the productive tension between these accounts. Chomsky's nativism explains what interactionist theories struggle to — Bailey's comed error is something her mother has never modelled. Yet Bruner and Vygotsky explain what Chomsky underplays — the rich pragmatic and lexical scaffolding visible throughout this transcript. The two frameworks are best read as complementary: innate capacity is activated through social interaction.</p>
...
<p>Overall, this transcript illustrates how language acquisition is a dynamic, interactive process. Bailey's development reflects both innate grammatical capacity, as Chomsky would argue, and the crucial role of social interaction and caregiver support emphasised by Bruner and Vygotsky. Her language is broadly consistent with, and in some respects slightly ahead of, what would be expected for a child of three years.</p>`,
        ...
        markScheme: `<p>Cambridge expects analysis of both Bailey's emerging features and the mother's CDS, integrated with named theorists. AO4 (15 marks) carries the most weight.</p>
...
<p>We have already shown that all who have considered the subject believe that the creation of district and separate schools is the only remedy for the evils of the workhouse schools.</p>`
          },
          {
            ...
            text: `<p>The top six nouns used alongside 'class' with 'and'/'or', from the English Historical Book Collection corpus (1473–1800) and the English Web 2015 corpus.</p>
<table style="width:100%; max-width:480px; margin:14px auto; border-collapse:collapse; font-family:'Cormorant Garamond',serif;">
...
<tr><td style="padding:6px 14px; border:1px solid #c9bda1; text-align:center;">sort</td><td style="padding:6px 14px; border:1px solid #c9bda1; text-align:center;">ethnicity</td></tr>
          ...
          },
          {
            ...
            text: `<p>n-gram graph for the words jail and gaol (1800–2000).</p>
<p>The graph shows that jail rose unevenly through the 19th century, peaked in the 1960s–70s, and remained dominant into the 2000s. Gaol remained at low frequency throughout, declining to near zero by 2000.</p>`
          }
        ],
        plan: {
          ...
          structure: [
            "Intro: 'Text A is an extract from an official report about education in England, published in 1861. It provides a valuable insight into Late Modern English (LME) and, when read alongside Texts B and C, illustrates how the English language has changed significantly in terms of graphology, orthography, morphology, phonology, lexis and grammar over the past century and a half.'",
            "Lexis & semantics: 'pauper', 'pauperism', 'workhouse' — words tied to a vanished social system (Halliday's functional theory). 'Class' shifted in collocation (Text B): from rankes/nobility to race/gender/ethnicity.",
            "Orthography & graphology: 'gaol' for 'jail' (Text C) — orthographic doublet from variant French regional spellings (substratum from Norman vs Central French). Caxton (1476) and Johnson (1755) standardisation by 1861 is largely complete.",
            "Morphology: 'pauperism' — productive -ism suffix on Latinate root; 'physiognomy' Greek root + -y; 'workhouse' transparent Anglo-Saxon compound. Substratum theory in action.",
            "Grammar & syntax: Long, semicolon-joined sentences; cleft structures ('It is from this neglected class…'); institutional we. Connect to Fairclough's informalisation and Mair's colloquialisation.",
            "(Optional) Pragmatics: Emotive/rhetorical language — Victorian didactic register inappropriate today.",
            "Conclusion (2 sentences): Texts A, B, C show change driven by industrial-era social structures giving way to modern conceptions."
          ],
          theorists: [
            "Halliday — pauper/workhouse fade as institutions disappear",
            "Aitchison — narrowing of class; PIDC for jail/gaol",
            "Crystal — tide metaphor for gaol",
            "Substratum theory — gaol/jail doublet from competing French regional pronunciations after 1066",
            "Fairclough/Mair — informalisation/colloquialisation",
            "Caxton/Johnson — earlier standardisation"
          ],
          tips: "The substratum origin of gaol/jail from Norman vs Central French is a strong AO4 marker. Don't ignore Text C."
        },
...
<p>The most distinctive feature of Text A is its lexis and semantics. The repeated nouns pauper, pauperism and workhouse belong to a Victorian social vocabulary tied to institutions that have effectively disappeared in modern Britain. The Poor Laws were repealed in 1948 and the workhouse system dismantled, with the consequence that the words attached to that system have followed it into low-frequency usage. Halliday's functional theory of language change explains this elegantly: words exist to serve the communicative needs of their users, and when the underlying concept disappears, the lexical item adapts or fades. Pauper survives only in historical contexts; a modern report on child poverty would prefer terms like vulnerable children or those in need, reflecting an entirely different conception of poverty that frames it as a structural problem to be remedied rather than, as in Text A, a moral category to be reformed.</p>

<p>The shift in the lexical field around class is corroborated by Text B. The 1473–1800 collocates — rankes, century, rank, division, nobility, sort — place class firmly in a hierarchical conceptual field denoting a fixed social tier. The 2015 collocates — race, workshop, gender, seminar, group, ethnicity — show class reframed as one identity dimension among several. This is a clear example of Aitchison's principle of semantic shift: class has narrowed from a general taxonomic noun to a specifically socio-economic one, while simultaneously broadening in social application.</p>

<p>Text C provides further lexical evidence through an n-gram graph tracking jail and gaol. Both spellings derive from regional variants of Old French — gaol from Norman French and jail from Central French — both of which entered English following the Norman Conquest of 1066 as part of the substratum influence of French on Middle English. For centuries the two forms competed, with gaol retaining institutional and legal currency while jail became the everyday form. Text C shows this competition resolving in favour of jail, consistent with David Crystal's tide metaphor: change is gradual but inexorable, and there is no permanent vocabulary.</p>

<p>Orthographically and graphologically, Text A is largely modern. The long-s (ſ) had been abandoned in printed texts by the early 19th century, and Text A — published in 1861 — uses only the round-s. Spelling is broadly aligned with modern British conventions, reflecting the consolidation that followed Samuel Johnson's dictionary (1755) and the spread of compulsory education through the 19th century. The continued use of gaol is the principal orthographic feature reflecting historical change. The standardisation that Caxton's printing press began in 1476, and that Johnson formalised, was effectively complete by the time Text A was written.</p>

<p>Morphologically, Text A displays the layered character of English vocabulary. Pauperism attaches the productive -ism suffix to a Latinate root. Physiognomy derives entirely from Greek and arrives through scholarly Latinate channels. Workhouse, by contrast, is a transparent Anglo-Saxon compound, reflecting the older Germanic stratum of English vocabulary. This stratification — Anglo-Saxon for everyday and concrete, French and Latin for legal and abstract, Greek for technical — is the long-term consequence of substratum influence, particularly the Norman French superstratum after 1066, which left thousands of words layered on top of the existing Old English base.</p>

<p>The grammar and syntax of Text A reflect the conventions of formal Victorian institutional prose. Sentences are characteristically long and complex, joined by semicolons and embedded clauses. A modern government report would almost certainly fragment these into shorter sentences. The cleft sentence "It is from this neglected class of children… that juvenile criminals spring" places thematic emphasis through inversion, a rhetorical structure now associated with persuasive writing rather than factual reporting. The use of the institutional we ("We addressed", "If we could withdraw them") confers collective authority. Together these features illustrate Fairclough's concept of informalisation: modern public language has shifted decisively towards the conversational, a trend Mair has named colloquialisation, accelerated in the digital era.</p>

<p>Overall, Texts A, B and C together illustrate how English has evolved across multiple linguistic levels in the past 160 years. The most significant changes are lexical and pragmatic: words rooted in Victorian institutions have receded as those institutions disappeared, while the conceptual field around class has been substantially restructured.</p>`,
     ...
     ============================================================ */
  {
    ...
    questions: [
      ...
      /* === 2022 J41 — Indian English === */
      {
        ...
        marks: 25,
        prompt: "Discuss what you feel are the most important issues raised in the text relating to the changing use of English in the world. You should refer to specific details from the text as well as to ideas and examples from your wider study of English in the world.",
        sources: [
          {
            label: "Stimulus — Kalpana Mohan, An English Made in India (2019)",
            text: `<p>What inspired you to write on the topic of Indian English?</p>
...
<p>Your book begins with the lines from Derek Walcott's 'Tropic Zone' — 'This is my ocean, but it is speaking / Another language.' Why?</p>
...
<p>You write — 'There is little doubt that Indian English is powerful — and temperamental. One might even say that it resembles the car steered by James Bond.' Can you elaborate?</p>
...
<p>Where do you think Indian English is headed?</p>
<p>We've already begun seeing India-centric words entering the Oxford dictionary (yaar, churidar and bhelpuri are examples). We will see many more, I'm sure. I think Indian English will be shaped even more by American and other Englishes; just as Indian English of the late 20th century took on aspects of the language of the Raj and Britain.</p>`
          }
        ],
        plan: {
          intro: "Paper 4 Section A discursive question. Engage with ownership (Widdowson), Kachru's circles and their limits, Schneider's Dynamic Model, Phillipson's counter-argument, and bidirectional lexical flow. Do not perform feature analysis on the stimulus.",
          structure: [
            "Introduction: Pose thesis: Mohan's account vindicates Widdowson on ownership while complicating Kachru's static circles.",
            "Ownership: Widdowson — once a community adopts English, they own it. Mohan's 'normal English' phrasing reveals the Inner-Circle norm she is implicitly resisting.",
            "Kachru and its limits: Outer-Circle classification understates Indian English's status.",
            "Schneider: Indian English fits Phase 4 — internal norms, dictionaries, literary tradition.",
            "Counter — Phillipson: Linguistic imperialism explains the colonial origin. But Widdowson's response: agency in adoption.",
            "Bidirectionality: Oxford adopting yaar, churidar, bhelpuri. Crystal's pluralisation; Jenkins/Seidlhofer's ELF.",
            "Conclusion: Ownership has moved out of the Inner Circle."
          ],
          theorists: [
            "Widdowson — ownership",
            "Kachru — Three Circles, with critique",
            "Schneider — Dynamic Model: Phase 4",
            "Phillipson — linguistic imperialism (counter)",
            "Crystal — pluralisation",
            "McCrum (Globish), Jenkins/Seidlhofer (ELF)"
          ],
        ...
        model: `<p>Kalpana Mohan's interview makes a celebratory case for Indian English as a distinctive, legitimate and now globally influential variety of the language. Her observations — that Indian English has its own "widgets and handles", that it carries the "colour of India", and that it is now contributing words back to the Oxford dictionary — invite a reassessment of the relationship between native-speaker English and the world Englishes that have evolved out of contact, colonialism and adoption. The most important issues raised concern the question of ownership: who has the right to determine what counts as legitimate English.</p>

<p>Mohan's central implicit claim — that Indian English is fully owned by its Indian users — is supported powerfully by Henry Widdowson's argument that English has long since stopped belonging to its native speakers. Widdowson contends that once a community adopts a language, they own it and may legitimately innovate. There is no "real" English to defend against deviation. Read against this position, Mohan's slightly defensive phrasing — that Indianisms "don't exist in normal English" — is itself revealing. Why is American or British English the implicit default against which Indian English is measured? Widdowson's argument is precisely that this Inner-Circle norm is illegitimate.</p>

<p>Braj Kachru's Three Circles model has long structured discussion of world Englishes. But the static character of Kachru's model is one of its main weaknesses. The Indian English Mohan describes is not an Outer-Circle variety in the sense of borrowing from an external prestige norm; it is a variety with its own conventions ("do the needful", "kindly", emphatic only), its own creative resources ("commit no nuisance"), and its own outflow into the wider global lexicon.</p>

<p>Edgar Schneider's Dynamic Model offers a more accurate framework. Indian English is plausibly in Phase 4 (endonormative stabilisation): internal norms have emerged, Indian dictionaries of English are being compiled, Indian publishing operates substantially in Indian English, and Bollywood and Indian writing have built considerable cultural prestige. Mohan's whole project — a book celebrating Indian English as Indian — is itself a marker of endonormative stabilisation.</p>

<p>It would be intellectually dishonest, however, to celebrate Indian English without acknowledging Robert Phillipson's framework of linguistic imperialism. The fact that approximately 125 million Indians use English at all is the direct legacy of British colonial rule. Mohan's celebratory account does not, and probably cannot, escape this history. Yet Widdowson's response to Phillipson is also worth weighing: agency in adoption matters. The imperial origin does not foreclose contemporary ownership.</p>

<p>The most striking detail in Mohan's interview is the bidirectional flow she describes. Yaar, churidar and bhelpuri have entered the Oxford English Dictionary — the institutional centre of Inner-Circle norm-setting now codifying Outer-Circle innovations. This reverses the historical direction of influence and supports David Crystal's optimistic prediction that English is pluralising into many co-existing world Englishes. Robert McCrum's notion of Globish, and Jennifer Jenkins's research on English as a Lingua Franca, similarly suggest that the most important version of English in the 21st century is the lingua franca used between non-native speakers.</p>
...
<li>Reproducing Kachru's diagram without critique</li></ul>`
      ...
      /* === 2023 J41 — Ableist Language === */
      {
        ...
        marks: 25,
        prompt: "Discuss what you feel are the most important issues raised in the text relating to the ways in which language can shape and reflect how individuals think. You should refer to specific details from the text as well as to ideas and examples from your wider study of Language and the self.",
        sources: [
          {
            label: "Stimulus — BBC, 'The harmful ableist language you unknowingly use' (2021)",
            text: `<p style="text-align:center;">The harmful ableist language you unknowingly use</p>
...
<p>Hale adds: 'We build a world with the language we use, and for as long as we're comfortable using this language, we continue to build and reinforce disableist structures.'</p>`
        ...
        plan: {
          ...
          structure: [
            "Introduction: Strong Whorfian claim. Thesis: strong claim overstates; weak claim well supported.",
            "Sapir-Whorf: Strong vs weak versions. Boroditsky's Russian-blues study supports weak relativity.",
            "Pinker's counter: Mentalese. The deaf author's own counter-example.",
            "Whorf-lite stands up: Lakoff & Johnson on conceptual metaphor.",
            "Identity and reclaiming: The author reclaims 'deaf' positively (Coupland; Eckert).",
            "Social construction: Hale's 'we build a world' echoes Foucauldian discourse theory.",
            "Conclusion: Strong claim unsustainable; weak claim well supported."
          ],
          theorists: [
            "Sapir-Whorf — strong vs weak",
            "Pinker — mentalese",
            "Boroditsky — empirical support for weak relativity",
            "Lakoff & Johnson — conceptual metaphor",
            "Coupland — style-shifting",
            "Eckert — community of practice; identity"
          ],
...
<p>The most direct theoretical framework for the article's claim is the Sapir-Whorf hypothesis. In its strong form (linguistic determinism), the hypothesis holds that language constrains thought. Applied to ableist idioms, the strong Whorfian reading would say that English speakers cannot easily conceive of deafness positively because the available idioms systematically encode deafness as wilful ignorance. Yet the strong determinist claim is widely regarded as untenable. The very existence of the article's author — a deaf person who explicitly reframes deafness as something positive — demonstrates that English speakers are perfectly capable of conceiving of deafness in ways that contradict the encoded idioms.</p>

<p>Steven Pinker's response to Whorf is decisive on this point. Pinker argues for mentalese — a universal language of thought independent of any particular spoken language. From Pinker's perspective, ableist idioms are at most a distortion in expressive resources, not a constraint on thought itself.</p>

<p>However, it would be too quick to dismiss the article's claim entirely. The weak relativity version of the hypothesis — that language influences but does not determine thought — has substantial empirical support. Lera Boroditsky's research has shown measurable cognitive effects of linguistic categories, including her well-known study of Russian speakers' faster discrimination of light blue (goluboy) and dark blue (siniy). The effects are real but modest. Translated to the article's argument, weak relativity would predict that English speakers' default associations with deafness are subtly shaped by repeated exposure to ableist idioms, even if they remain capable of overriding those associations.</p>

<p>George Lakoff and Mark Johnson's work on conceptual metaphor sharpens this argument. Lakoff and Johnson argue that idioms are not random but reflect deep conceptual mappings: argument is war, time is money, and understanding is sight. The ableist idioms the article identifies are not isolated phrases but instances of a systematic conceptual mapping in which sensory or cognitive disability stands in for moral or intellectual failing.</p>

<p>The article also touches on identity construction through language. The author opens by reclaiming 'deaf' as a positive identity marker. This is a clear instance of what Penelope Eckert has theorised as identity formation in communities of practice. Within the deaf community, 'deaf' is not the negative idiomatic term it appears to be in mainstream English; it is a name. Nikolas Coupland's work on style-shifting similarly emphasises that speakers actively construct identity through linguistic choice.</p>
...
<p>Sapir-Whorf, Pinker, Boroditsky, Lakoff (conceptual metaphor), Coupland, Eckert.</p>`
      ...
      /* === 2025 N41 — Female Email === */
      {
        ...
        marks: 25,
        prompt: "Discuss what you feel are the most important issues raised in the text relating to the ways in which language can shape and reflect personal and social identity. You should refer to specific details from the text as well as to ideas and examples from your wider study of Language and the self.",
        sources: [
          {
            label: "Stimulus — Forget the 'female email' rules (Schwa, 2022)",
            text: `<p style="text-align:center;">Forget the 'female email' rules</p>
<p>As women, we're told to swerve certain 'female' writing habits in emails. If we want to be taken seriously at work, we need to: cut out any self-deprecation (sorry, I'm no expert, does that make sense?); stop softening our tone with exclamation marks and emojis; take out phrases that 'dilute' your message, like just and I think.</p>
...
<p>I've had a can I ask a stupid question? habit for years. But I've come to see that question as a handy tool: it opens up the conversation and puts the other person at ease. Same with sorry, same with just. And why is it so terrible to say I think?</p>
...
<p>We're damned if we do and damned if we don't. Too fluffy, and we're told we're not assertive enough. Not fluffy enough, and we're told we're being harsh.</p>`
        ...
        plan: {
          ...
          structure: [
            "Introduction: Thesis: the article's central insight — that style advice marketed at women is structural displacement — is well supported by Cameron and Giles.",
            "Lakoff: The article's targets are Lakoff's exact 1975 list. Advice industry is essentially Lakoffian — reversed to push women to drop the features.",
            "Cameron's critique: Features are not female; they are markers of relational style. Cameron directly underwrites the article.",
            "Tannen with caveats: Rapport vs report captures the intuition but Tannen heavily critiqued for essentialism.",
            "Giles' Accommodation: Who accommodates to whom? Lower-status speakers converge upwards. The advice is one-way upward convergence.",
            "Eckert's CoP: Style is identity performance, not personal failing.",
            "Conclusion: Who has the power to set communicative norms, and to whose advantage?"
          ],
          theorists: [
            "Lakoff — 'women's language' (with critique)",
            "Cameron — Myth of Mars and Venus",
            "Tannen — rapport vs report (with reservations)",
            "Giles — accommodation",
            "Eckert — community of practice",
            "Coupland — style-shifting"
          ],
        ...
        sources: [
          {
            ...
            text: `<p style="text-align:center;">Singlish is here to stay — and the government should accept it</p>
...
<p>This view is wrong. Linguistically, Singlish is not broken English; it is a creole that has emerged from contact between English, Malay, Hokkien, Cantonese and Tamil over four generations of Singaporean speakers. It has its own grammar (the famous final particles lah, leh, lor; topic-prominent sentences such as 'this book I already read'), its own lexicon ('shiok', 'chope', 'kiasu'), and native speakers — Singaporean children for whom Singlish is the first language of the playground.</p>
...
<p>Other postcolonial Englishes have made the journey from disreputable creole to acknowledged national language. Indian English is now the dominant variety of English in print. Caribbean English has produced Nobel laureates. Why should Singapore continue to apologise?</p>`
        ...
        plan: {
          ...
          structure: [
            "Introduction: Linguistic case overwhelming; political case must engage with intelligibility concerns. Schneider helps resolve the tension.",
            "Singlish as creole: Native speakers, full grammatical system, productive lexicon — fits every linguistic definition.",
            "Kachru and its limits: Boundaries are fluid.",
            "Schneider: Singapore at Phase 4 (endonormative stabilisation). Speak Good English Movement is reactionary attempt to push back to Phase 2.",
            "Phillipson and the state: But the government's position isn't pure linguistic imperialism — Jenkins' LFC mediates.",
            "Bidialectalism: Most Singaporeans operate diglossically. McCrum's Globish supports coexistence.",
            "Conclusion: Bidialectal coexistence, not zero-sum competition."
          ],
          theorists: [
            "Pidgin/Creole distinction",
            "Kachru — Three Circles, with critique",
            "Schneider — Phase 4",
            "Widdowson — ownership",
            "Phillipson — linguistic imperialism",
            "Jenkins/Seidlhofer — LFC",
            "McCrum — Globish",
            "Diglossia/bidialectalism"
          ],
...
<p>The author's strongest point is the linguistic one. Singlish is not broken English; it is a creole. A creole is a stable contact variety that has acquired native speakers and a full grammatical system. Singlish meets every part of that definition: it has emerged over four generations through contact between English, Malay, Hokkien, Cantonese and Tamil; it has its own grammatical system, including topic-prominent syntax and the rich set of final particles (lah, leh, lor) that mark stance, mood and affect; it has a productive lexicon; and it has native speakers. This is the same status held by other major creole Englishes — Jamaican Patois, Tok Pisin, Caribbean Creole — all of which linguists treat as fully-fledged languages.</p>
...
<p>Edgar Schneider's Dynamic Model gives a more accurate picture. Singapore is plausibly in Phase 4 (endonormative stabilisation): there is a substantial Singaporean literary tradition in Singlish, Singlish is used in domestic film and advertising, and there is conscious pride in the variety. The Speak Good English Movement is a reactionary state attempt to roll the country back to Phase 2 — exonormative stabilisation. The campaign's persistence and its evident failure both illustrate Schneider's claim that the dynamic moves only one way.</p>

<p>The article's political argument runs in parallel to Henry Widdowson's claim about ownership. The Speak Good English Movement is an institutionalised denial of Widdowson's claim — an insistence that the legitimate version of English remains the version spoken in London and Boston.</p>

<p>It would, however, be too quick to dismiss the Singaporean government's position as pure linguistic imperialism (Robert Phillipson's framework). The campaign was designed to ensure Singaporean professionals could communicate with international business partners. There is a real tension between Widdowson's principled defence of ownership and the practical question of intelligibility. Jennifer Jenkins and Barbara Seidlhofer's work on ELF offers a useful intermediate position: there is a Lingua Franca Core of features essential for international intelligibility, but many other features can vary by variety.</p>

<p>This points to the most defensible position: bidialectalism. Most Singaporeans already operate diglossically — Singlish in informal domains, Standard English in formal ones. Robert McCrum's notion of Globish is useful here: international English coexists with local varieties; it does not replace them. The Speak Good English Movement's foundational error is to frame the relationship as zero-sum.</p>

<p>The article's broader celebration of postcolonial Englishes supports David Crystal's argument that the future of English lies in its pluralisation. English is becoming the property of all its users rather than any one nation.</p>
        ...
        sources: [
          {
            ...
            text: `<p style="text-align:center;">Which me are you talking to?</p>
...
<p>What was painful about code-switching was the asymmetry. My white colleagues did not, as far as I could see, have to suppress an alternative version of themselves to come to work. Their voices at the office were continuous with their voices at home. Mine were not. That asymmetry is not an accident of personality. It is the consequence of who set the norms of professional speech.</p>`
        ...
        plan: {
          ...
          structure: [
            "Introduction: Two questions: whether there is a 'real self' beneath linguistic adjustment, and why some speakers carry more switching labour than others.",
            "Giles' Accommodation: Office voice is upward convergence; mother voice is downward (in-group) convergence.",
            "Coupland on style-shifting: Identity is performed, not pre-existing.",
            "Eckert's CoP: Each community has its own repertoire. Writer is competent across multiple CoPs.",
            "The 'no true self' move: Butlerian performativity applied linguistically — identity constituted in performance.",
            "Asymmetry argument: The strongest part — white colleagues don't switch because the norm was set by their home voice. Politics of accommodation.",
            "Conclusion: Code-switching is competent; the problem is structural unequal labour."
          ],
          theorists: [
            "Giles — Communication Accommodation Theory",
            "Coupland — style-shifting; identity performance",
            "Eckert — community of practice",
            "Butler (linguistically applied) — performativity",
            "Labov — Martha's Vineyard; identity through phonology",
            "Code-switching theory — Myers-Scotton"
          ],
