  ...
  skills: [
    {
      ...
      points: [
        "Start with Text A — identify the most distinctive features (graphology, lexis, grammar, orthography). These are your data points.",
        "Bring in Text B when discussing lexical/semantic shift — the corpus tables show which collocates have changed over time.",
        "Use Text C (n-gram graph) to track frequency change of specific words. Always describe the trend before interpreting it.",
        "Cross-reference rather than treating each text in isolation — top-band candidates weave evidence from all three texts into a single argument."
      ],
      example: "The decline of 'unbecoming' shown in Text C aligns with the lexical replacement seen in Text B, where 'humour' has shed its medical and moral connotations in favour of comedic ones — a pattern of narrowing consistent with Aitchison's model of semantic change.",
      warning: "Listing features without analysis. \"Text A uses the long-s\" is description, not analysis. You must explain why the feature matters and what it tells us about language change."
    },

    {
      tag: "AO4",
      title: "Conceptualisation — Using Theory Effectively",
      intro: "AO4 rewards you for showing you know why language behaves the way it does. This means deploying named theorists, models and frameworks — but only where they illuminate your evidence. Theory dumping (listing everything you know about Aitchison without applying it) scores in the lower bands.",
      points: [
        "Name the theorist precisely — \"Aitchison's PIDC model\" not \"a theory\".",
        "Apply the theory to a specific feature in the data — show how it explains the change.",
        "Synthesise rival accounts at top-band level — e.g., balancing Chomsky's nativist view with Bruner's interactionist account in CLA.",
        "Be selective — three deeply applied theories beat eight name-drops."
      ],
      example: "Bailey's repeated use of 'comed' demonstrates a virtuous error: she has internalised the regular past-tense rule and is over-extending it to an irregular verb. This supports Chomsky's LAD hypothesis — Bailey is not imitating, she is constructing.",
...

    {
      ...
      points: [
        "Use precise terminology — \"graphological\", \"orthographic\", \"morphological\", not \"the way it looks\".",
        "Embed quotations smoothly — \"the use of 'publick' reflects pre-Johnson orthographic conventions\".",
        "Vary sentence structure — short sentences for emphasis, longer ones for nuance.",
        "Avoid colloquial fillers — no \"basically\", \"a lot\", \"things like that\"."
      ],
      example: "The phonological spelling 'shew' for 'show' reflects a transitional moment between the Great Vowel Shift's reshaping of long vowels and the orthographic standardisation that would follow Johnson's dictionary.",
...

    {
      ...
      points: [
        "Identify the stimulus's central claim in your introduction — what is the writer arguing?",
        "Quote selectively from the stimulus to anchor your discussion (1–3 short references).",
        "Engage critically — agree, qualify, or challenge with reasons.",
        "Don't summarise the stimulus at length — your essay should respond to it, not paraphrase it."
      ],
      example: "Mohan's claim that Indian English has become \"powerful and temperamental\" raises the question of ownership: if the variety has its own conventions, must we still measure it against \"normal English\"? Widdowson would argue no — once English moves beyond the Inner Circle, ownership passes to the new speakers.",
      warning: "Writing a generic essay on \"English in the world\" without engaging with the stimulus. The examiner needs to see you have read the source."
    },

    {
      tag: "P4",
      title: "The Discursive Essay (Paper 4)",
      intro: "Paper 4 essays are discursive, not analytical. You are debating ideas using language theory — you are not performing feature analysis on the stimulus text. This is the single most common error on Paper 4.",
      points: [
        "Build an argument, not a feature list — your essay should have a clear thesis.",
        "Bring in named theorists as authorities to support or complicate your position.",
        "Use your own examples — varieties of English you have studied, instances of language and identity.",
        "Acknowledge counter-arguments — top-band essays show critical balance.",
        "Avoid analysing the stimulus's lexis, grammar or graphology — that is Paper 3 territory and earns no AO5 credit on Paper 4."
      ],
      example: "While Phillipson's framework of linguistic imperialism captures the historical dynamics of English's global spread, it risks denying agency to non-native users. Widdowson's notion of ownership offers a more productive framing: English has been adopted, adapted and made local. Mohan's account of Indian English supports this — \"do the needful\" is not flawed English but appropriated English.",
  ...
  topics: {
    ...
    languageChange: {
      ...
      flashcards: [
        ...
        { id: "lc30", tag: "Internal vs External", front: "Internal vs external causes?", back: "Internal: changes from within the language system (analogy, ease of articulation, simplification). External: changes from contact, technology, social shifts (Norman conquest, printing, digital media)." }
      ]
    },
    ...
    childLanguage: {
      ...
      flashcards: [
        ...
        { id: "cla15", tag: "Errors", front: "Overextension vs underextension?", back: "Overextension: applying a word too widely (calling all four-legged animals 'doggie'). Underextension: applying it too narrowly (only the family pet is 'doggie')." },
    ...
    englishWorld: {
      ...
      flashcards: [
        { id: "ew1", tag: "Theorist · Kachru", front: "What are Kachru's Three Circles?", back: "Inner Circle: native-speaker countries (UK, US, Australia). Outer Circle: ESL countries (India, Singapore, Nigeria). Expanding Circle: EFL countries (China, Brazil, Russia)." },
        ...
        { id: "ew12", tag: "Concept · Continuum", front: "What is the creole continuum?", back: "The range from basilect (most distant from standard, e.g. deep Singlish) to mesolect (intermediate) to acrolect (closest to standard English). Speakers shift along this continuum depending on context." },
        ...
        { id: "ew15", tag: "Variety · Indian English", front: "Three features of Indian English?", back: "(1) Use of only for emphasis ('he's like that only'). (2) Verbs like do the needful. (3) Pre-pone (the opposite of postpone). All Indian innovations now widely accepted." },
        { id: "ew16", tag: "Variety · Singlish", front: "Three features of Singlish?", back: "(1) Final particles: lah, leh, lor. (2) Topic-prominent grammar ('this book I already read'). (3) Tense reduction (often inferred from context rather than morphology)." },
        { id: "ew17", tag: "Variety · AAVE", front: "Three features of AAVE?", back: "(1) Habitual be ('he be working' = he habitually works). (2) Multiple negation ('I ain't got no money'). (3) Copula deletion ('she happy'). All systematic and rule-governed." },
        { id: "ew18", tag: "Concept · Zero translation", front: "What is zero translation?", back: "Loanwords adopted into a language without any translation or modification.", example: "Yaar, bhelpuri, guru entering English from Indian languages." },
        { id: "ew19", tag: "Concept · Three Futures", front: "What are the three futures of English?", back: "(1) Fragmentation: English splits into mutually unintelligible varieties. (2) Maintenance: a global standard endures. (3) Replacement: Mandarin or Spanish overtakes it." },
        ...
        { id: "ew21", tag: "Tip", front: "What's the worst error on Paper 4 Section A?", back: "Performing linguistic feature analysis on the stimulus text — discussing its lexis, syntax, graphology. Paper 4 is discursive: engage with the ideas, deploy theorists." }
      ]
    },
    ...
    languageSelf: {
      ...
      flashcards: [
        { id: "ls1", tag: "Theorist · Sapir-Whorf", front: "What is the Sapir-Whorf hypothesis?", back: "The claim that the language we speak shapes how we think. Strong version (linguistic determinism): language constrains thought. Weak version (linguistic relativity): language influences but does not determine thought." },
        ...
        { id: "ls3", tag: "Theorist · Boroditsky", front: "What did Boroditsky's Russian blues study show?", back: "Russian distinguishes light blue (goluboy) from dark blue (siniy) at the lexical level. Russian speakers were faster at distinguishing the two shades — suggesting weak Whorfian effects." },
        ...
        { id: "ls5", tag: "Theorist · Giles", front: "Upward vs downward convergence?", back: "Upward: shifting towards a higher-prestige variety to gain approval (e.g., dropping regional accent in job interview). Downward: shifting towards a lower-prestige variety to fit in or build solidarity." },
        ...
        { id: "ls9", tag: "Theorist · Trudgill", front: "Overt vs covert prestige?", back: "Overt prestige: the value attached to standard, mainstream forms (RP, written standard). Covert prestige: the value attached to non-standard forms within a community — masculinity, toughness, in-group loyalty." },
        { id: "ls10", tag: "Theorist · Cheshire", front: "What did Cheshire find in Reading?", back: "Cheshire studied adolescents in Reading and found non-standard grammatical variants (multiple negation, ain't) correlated with peer-group identity and 'vernacular culture' values." },
        ...
        { id: "ls15", tag: "Theorist · Cameron", front: "What is Deborah Cameron's critique?", back: "Cameron (2007, The Myth of Mars and Venus) argues most claims about gendered language are myth — stylistic differences are small, contextual, and outweighed by within-gender variation." },
        ...
        { id: "ls18", tag: "Variety · MLE", front: "What is Multicultural London English?", back: "An emerging variety of English in inner London, drawing on Caribbean, South Asian and African Englishes. Features include: th-fronting, monophthongal vowels, the discourse marker innit." },
        { id: "ls19", tag: "Concept · Idiolect / Sociolect", front: "Idiolect, sociolect, dialect?", back: "Idiolect: an individual's unique speech patterns. Sociolect: language patterns shared by a social group (class, ethnicity, profession). Dialect: regional variation." },
        ...
        { id: "ls23", tag: "Concept · Identity Performance", front: "What does it mean to 'perform' identity?", back: "Drawn from Butler (gender) and applied linguistically — the idea that identity is not a fixed essence we express, but an ongoing performance constituted partly by linguistic choices. We do identity through language." },
        { id: "ls24", tag: "Concept · Innatism vs Empiricism", front: "Innatism vs Empiricism?", back: "Innatism / Nativism: some linguistic capacity is biologically pre-wired (Chomsky). Empiricism: language is learned entirely from environmental input (Skinner, Tomasello)." }
      ]
    }
  },
